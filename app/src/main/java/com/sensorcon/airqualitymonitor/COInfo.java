...
public class COInfo extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String test = "At concentrations of <5ppm, you probably don't need to worry, just keep an eye on it.  At higher concentrations, you need to investigate further.";
		...
		addTextRow("\u2022 Keep an eye on it, it's normal to see small transients  of 1-2ppm. " +
				"If it stays in the 3-5ppm range, there may be a very small amount of CO present.",
				Typeface.NORMAL);
		addTextRow("\u2022 Concentrations moving between 0-3ppm are typically sensor noise; "  +
		...
		addTextRow("\u2022 If outdoors, pay attention to what\u2022s going on around you to try to identify potential sources.  See if lower concentrations are observed in different locations.", Typeface.NORMAL);

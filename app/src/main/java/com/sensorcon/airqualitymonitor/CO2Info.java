...
public class CO2Info extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addTextRow("Possible Meaning:", Typeface.BOLD_ITALIC);
		addTextRow("Values over 1000 could be a sign of poor building ventilation. Sensitive people may notice headaches and/or general fatigue.",
					Typeface.NORMAL);
		addTextRow("What you should do:", Typeface.BOLD_ITALIC);
		addTextRow("\u2022 Check the outdoor CO2 level, as this will affect the indoor level as well. Typically, the indoor level should not more than 600 ppm above the outdoor level",
				Typeface.NORMAL);
